...
export class AppComponent{
  ...
  constructor(private fb: FormBuilder) {
    ...
    this.shows.sort(this.sort_by_name)
  }

  // Cargar show en el formulario de edición
  ...
  public onSubmitEdit(): void {
    if (this.editForm.valid) {
      if (this.showToEdit !== null) {
        Object.assign(this.showToEdit, this.editForm.value);
      }
      this.showToEdit = null; // Limpiar selección
      this.sort_shows(); // Reorganizamos las tarjetas
    }
  }

  // Cancelar edición
  public cancelEdit(): void {
    this.showToEdit = null;
  }

  public invert: number  = 1;
  ...
  public sort_by_date(show1:Show, show2:Show): number{
    return (show1.year - show2.year);
  }

  public sort_by_name(show1:Show, show2:Show): number{
  ...
  public sort_shows(): void {
    if (this.orderBy == "name") {
      ...
      this.shows.sort(this.sort_by_date);
    }
    if (this.invert == -1) {
      this.shows.reverse();
    }
